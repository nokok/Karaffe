...
public class NewASTVisitor extends KaraffeBaseVisitor<Tree> implements PositionContext {
    ...
    public Tree visitMainMethodDef(KaraffeParser.MainMethodDefContext ctx) {
        ...
        KaraffeParser.StatementBlockContext statementBlockContext = ctx.statementBlock();
        if (statementBlockContext != null) {
            KaraffeParser.StatementContext statementContext = statementBlockContext.statement();
            KaraffeParser.StatementListContext statementListContext = statementBlockContext.statementList();
            if (statementContext != null) {
                mainMethodDef.addBody(statementContext.accept(this));
            }
            while (statementListContext != null) {
                KaraffeParser.StatementContext innerStatementContext = statementListContext.statement();
                mainMethodDef.addBody(innerStatementContext.accept(this));
                statementListContext = statementListContext.statementList();
            }
        }
    ...
    public Tree visitStatement(KaraffeParser.StatementContext ctx) {
        ...
        if (ctx.letStmt != null) {
            return Defs.letDef(
                    ...
                    ctx.initializer == null ? Terms.emptyTree() : ctx.initializer.accept(this)
            );
        }
