...
public class KNormalizeTest {
    ...
    public void testCompileUnit() {
        testKNormalize("class Factorial {\r\n" +
                ...
                "(CompileUnit (PackageDef (Select <root>)) (ClassDef (Name Factorial) (Name Object) [(Block (MethodDef (Modifiers ()) (Name main) (Parameters (ValDef (Modifiers ()) (Name a) (TypeName String[]))) (TypeName void) [(Block (Assign (Name kn_0) (Select java lang System out println)) (Assign (Name kn_1) (New (Select Fac))) (Assign (Name kn_2) (Apply (Name kn_1))) (Assign (Name kn_3) (Select kn_2 computeFac)) (Assign (Name kn_4) (IntLiteral 10)) (Assign (Name kn_5) (Apply (Name kn_3) (Name kn_4))) (Assign (Name kn_6) (Apply (Name kn_0) (Name kn_5))))]))]) (ClassDef (Name Fac) (Name Object) [(Block (MethodDef (Modifiers (Modifier public)) (Name computeFac) (Parameters (ValDef (Modifiers (Modifier )) (Name num) (TypeName int))) (TypeName int) [(Block (VarDef (Modifiers ()) (Name numAux) (TypeName int)) (Assign (Name kn_7) (Select num)) (Assign (Name kn_8) (Select <)) (Assign (Name kn_9) (Select kn_7 kn_8)) (Assign (Name kn_10) (IntLiteral 1)) (Assign (Name kn_11) (Apply (Name kn_9) (Name kn_10))) (If (Name kn_11) [(Assign (Name kn_12) (IntLiteral 1)),(Assign (Name numAux) (Name kn_12))] [(Assign (Name kn_13) (Select num)),(Assign (Name kn_14) (Select *)),(Assign (Name kn_15) (Select kn_13 kn_14)),(Assign (Name kn_16) (ThisLiteral this)),(Assign (Name kn_17) (Select kn_16 ComputeFac)),(Assign (Name kn_18) (Select num)),(Assign (Name kn_19) (Select -)),(Assign (Name kn_20) (Select kn_18 kn_19)),(Assign (Name kn_21) (IntLiteral 1)),(Assign (Name kn_22) (Apply (Name kn_20) (Name kn_21))),(Assign (Name kn_23) (Apply (Name kn_17) (Name kn_22))),(Assign (Name kn_24) (Apply (Name kn_15) (Name kn_23))),(Assign (Name numAux) (Name kn_24))]) (Assign (Name kn_25) (Select numAux)) (Return (Name kn_25)))]))]))");
